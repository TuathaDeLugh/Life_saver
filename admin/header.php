        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0 me-n3">
                ...
                <div class="nav-item dropdown">
                    ...
                    ?>
                    <a class="btn text-white btn-primary nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">
                        <?php echo $uname; ?> Loged In
                    </a>
                    <div class="dropdown-menu m-0">
                        <a href="../admin/profile.php" class="dropdown-item"><u class="profile">Profile</u></a>
                        <a href="../admin/change.php" class="dropdown-item"><u class="changepass">Change
                                Password</u></a>
                        <div class="dropdown-divider"></div>
                        <a href="../context/main.php?logout=logout"><Button class="btn btn-danger"
                                Style="margin-left:20px;">Log Out</Button></a>
